...
$liste_poste_infos["info"] = array(
    "typewin" => $liste_hosts[$id_host]["OS_poste"],
    "status" => 0,
    "logfile" => $liste_hosts[$id_host]["file_log_poste"],
    "ip" => $liste_hosts[$id_host]["IP_poste"],
    "mac" => $liste_hosts[$id_host]["mac_address_poste"],
    "datetime" => $liste_hosts[$id_host]["date_rapport_poste"]
);
$liste_poste_infos["status"] = array(
    "Ok" => 0,
    "Not_Ok+" => 0,
    "Not_Ok-" => 0,
    "MaJ" => 0,
    "Nb_App" => count($liste_poste_app)
);
...
foreach ($liste_appli as $key_md5 => $appli) {
    $liste_poste_infos["app"][$appli["id_app"]] = array(
        "id_nom_app" => $appli["id_nom_app"],
    ...
    if (isset($liste_poste_rapport[$key_md5]["statut_poste_app"])) {
        switch ($liste_poste_rapport[$key_md5]["statut_poste_app"]) {
            case "Installed":
                $liste_poste_infos["app"][$appli["id_app"]]["statut_poste_app"] = "Install&#233;";
                break;
            case "Not Installed":
                $liste_poste_infos["app"][$appli["id_app"]]["statut_poste_app"] = "Non Install&#233;";
                break;
            default:
