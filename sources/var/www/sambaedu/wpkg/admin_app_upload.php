 ...
 * @Projet SambaEdu
 * @auteurs  Laurent Joly, Denis Bonnenfant
 * @note
...
<form name="formulaire" method="post" action=""
	...
	<table align="center">
		<tr>
			<td>Si vous avez déjà placé les fichiers nécessaires à l'application,
				sur le serveur: <br> <input name="noDownload" value="1"
				type="checkbox"></input>Ne pas télécharger les fichiers
				d'installation de cette application.<br>
			<br> Pour ajouter une application qui n'est pas répertoriée sur le
				serveur de référence, cocher cette case : <br> <input
				name="ignoreWawadebMD5" value="1"
				onclick="if(this.checked) alert('Soyez sûr du contenu du fichier xml que vous allez installer sur le serveur!\nAucun contrôle ne sera effectué !\n\nLa sécurité de votre réseau est en jeu !!');"
				type="checkbox"></input>Ignorer le contrôle de hashage.<br>
			<br>
			</td>
		</tr>
		<tr>
			<td>Fichier xml de définition de l'application :<br> <input
				title="chemin du fichier xml" size="70" name="appliXml" type="file"></input><input
				value="Ajouter cette application !" type="submit"></input>
			</td>
		</tr>
	</table>
</form>
