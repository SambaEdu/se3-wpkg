...
foreach ($liste_postes_parc as $poste) {
    ...
    $info_poste[$poste["nom_poste"]]["info"] = array(
        "typewin" => $poste["OS_poste"],
        "status" => 0,
        "nb_app" => count($tmp_appli),
        "logfile" => $poste["file_log_poste"],
        "ip" => $poste["ip_poste"],
        "mac" => $poste["mac_address_poste"],
        "datetime" => $poste["date_rapport_poste"]
    );
